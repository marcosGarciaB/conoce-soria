...
const ComentarioItem: React.FC<ComentarioItemProps> = ({ comentario, onDelete, onUpdate }) => {
                ...
                <View style={styles.modalBackground}>
                    <View style={styles.modalContainer}>
                        <Text style={styles.modalTitle}>
                            {actionType === 'delete' ? '¿Borrar comentario?' : '¿Actualizar comentario?'}
                        </Text>
                        <View style={styles.modalButtons}>
                            <TouchableOpacity style={[styles.modalButton, { backgroundColor: '#FF4D4D' }]} onPress={handleConfirm}>
                                <Text style={styles.modalButtonText}>Sí</Text>
                            </TouchableOpacity>
                            <TouchableOpacity style={[styles.modalButton, { backgroundColor: '#ccc' }]} onPress={handleCancel}>
